...
<head>
    ...
    <?php if($hasForm) echo "<link rel='stylesheet' href='css/feedback-form.css'>"; ?>
    <?php if($isLogin) echo "<link rel='stylesheet' href='css/login-form.css'>"; ?>
    <?php if($isMain) echo "<script src='script/slider.js' async></script>"; ?>
</head>
...
<body>
    ...
    <header>
        ...
        <div class="header-link-group">
            ...
            <a class="main-link login-btn" href="signin.php" target="_blank">Sign In</a>
        </div>
    </header>